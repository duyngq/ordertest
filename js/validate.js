...
function validation() {
  if (document.getElementById("custName").value.length == 0) {
    ...
    checknumber(document.getElementById("total_weight").value) == false
  ) {
    alert("Please enter total weight in number.");
    document.getElementById("total_weight").focus();
    return false;
  } else if (
    checknumber(document.getElementById("price_per_weight").value) == false
  ) {
    alert("Please enter Pirce (USD/kg) in number.");
    document.getElementById("price_per_weight").focus();
    return false;
  } else if (
    checknumber(document.getElementById("total_package_price").value) == false
  ) {
    alert("Please enter Total price in number.");
    document.getElementById("total_package_price").focus();
    return false;
  } else if (
    checknumber(document.getElementById("total_weight_1").value) == false
  ) {
    alert("Please enter total weight in number.");
    document.getElementById("total_weight_1").focus();
    return false;
  } else if (
    checknumber(document.getElementById("price_per_weight_1").value) == false
  ) {
    alert("Please enter Pirce (USD/kg) in number.");
    document.getElementById("price_per_weight_1").focus();
    return false;
  } else if (
    checknumber(document.getElementById("total_package_price_1").value) == false
  ) {
    alert("Please enter Total price in number.");
    document.getElementById("total_package_price_1").focus();
    return false;
  } else if (
    checknumber(document.getElementById("total_weight_2").value) == false
  ) {
    alert("Please enter total weight in number.");
    document.getElementById("total_weight_2").focus();
    return false;
  } else if (
    checknumber(document.getElementById("price_per_weight_2").value) == false
  ) {
    alert("Please enter Pirce (USD/kg) in number.");
    document.getElementById("price_per_weight_2").focus();
    return false;
  } else if (
    checknumber(document.getElementById("total_package_price_2").value) == false
  ) {
    alert("Please enter Total price in number.");
