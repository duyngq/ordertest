...
<table width='300' border='0' align='center' cellpadding='0' cellspacing='1' bgcolor='#CCCCCC'>
    <tr>
        ...
        if (isset($_SESSION['loggedIn']) && $_SESSION['loggedIn']) {
            ...
            ?>
        	<div class="container">
                <form name='form1' method='post' action="changepass.php" onsubmit="return validatePassword()">
                    <td>
                        <table width='100%' border='0' cellpadding='3' cellspacing='1' bgcolor='#FFFFFF'>
                            <tr>
                                <td colspan='3'><h2 align="center">Update user</h2></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                if ( isset($_GET['st'])) {
                                    if ($_GET['st'] == 0 ){
                                        echo "<label style='color:green'>Changed successully</label>";
	                                } else if ($_GET['st'] == 1 ){
                            ...
                            <tr>
                                ...
                                <td width='6'>:</td>
                                <td width='294'><input name='username' type='text' id='username' placeholder="<?php $user_name = $_SESSION['username'];echo $user_name; ?>" disabled></td>
                            </tr>
                            <tr>
                                <td><label><b>Old Password</b></label></td>
                                <td>:</td>
                                <td><input name='old-password' type='password' id='old-password' placeholder="Enter Password" required></td>
                            </tr>
                            <tr>
